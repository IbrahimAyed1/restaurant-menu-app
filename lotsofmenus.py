...
from db_test import Restaurant, Base, MenuItem, User
...
User1 = User(name="Ibrahim Ayed",
             email="ut_cheha@hotmail.com",
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description="A famous duck dish from Beijing[1] that has"
                                 ...
                                 "The meat is prized "
                                 "for its thin, crisp skin, with authentic "
                                 "versions of "
                                 "the dish serving mostly the "
                                 "skin and little "
                                 "meat, sliced in front of the diners "
                                 "by the cook",
...
menuItem4 = MenuItem(user_id=1, name="Chocolate Cake",
...
menuItem5 = MenuItem(user_id=1, name="Chocolate Cake",
                     description="fresh baked and served with ice cream",
                     price="$3.99", course="Dessert",
                     restaurant=restaurant1)
...
menuItem6 = MenuItem(user_id=1, name="Chocolate Cake",
                     description="fresh baked and served with ice cream",
                     price="$3.99", course="Dessert",
                     restaurant=restaurant1)
session.add(menuItem6)
...
menuItem7 = MenuItem(user_id=1, name="Chocolate Cake",
                     description="fresh baked and served with ice cream",
                     price="$3.99", course="Dessert",
                     restaurant=restaurant1)
...
menuItem8 = MenuItem(user_id=1, name="Chocolate Cake",
                     description="fresh baked and served with ice cream",
                     price="$3.99",
                     course="Dessert",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     ...
                     price="$8.99",
                     course="Entree", restaurant=restaurant3)
...
menuItem3 = MenuItem(user_id=1, name="Gyoza",
                     description="The most prominent differences between "
                                 ...
                                 "the light seasoning of Japanese gyoza"
                                 " with salt and soy sauce,and the fact that "
...
menuItem5 = MenuItem(user_id=1, name="Veggie Burger",
                     description="Juicy grilled "
                                 "veggie patty with tomato mayo and "
                                 "lettuce",
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake",
                     description="Rich, luscious sponge cake "
                                 "soaked in sweet milk and "
                                 "topped with vanilla bean "
                                 "whipped cream and strawberries.",
                     price="$2.99",
                     course="Dessert", restaurant=restaurant4)
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     description="Golden fried cauliflower "
                                 "florets in a midly spiced soya,"
                                 "garlic sauce cooked with "
...
menuItem6 = MenuItem(user_id=1, name="Veggie Burger",
...
menuItem2 = MenuItem(user_id=1, name="Chicken and Rice",
                     ...
                     course="Entree", restaurant=restaurant5)
...
menuItem1 = MenuItem(user_id=1, name="Lamb Curry",
                     description="Slow cook that thang in a pool of tomatoes,"
                                 "onions and all those tasty Indian "
                                 "spices. Mmmm.",
...
session.commit()
print "rest added"
menuItem1 = MenuItem(user_id=1, name="Chicken Fried Steak",
...
menuItem2 = MenuItem(user_id=1, name="Boysenberry Sorbet",
...
menuItem3 = MenuItem(user_id=1, name="Broiled salmon",
...
menuItem4 = MenuItem(user_id=1, name="Morels on toast (seasonal)",
...
menuItem5 = MenuItem(user_id=1, name="Tandoori Chicken",
                     description="Chicken marinated in yoghurt and"
                                 " seasoned with a spicy mix(chilli,"
                                 "tamarind among "
                                 "others) and slow cooked in a "
                                 "cylindrical clay or metal"
                                 " oven which gets its heat "
...
menuItem1 = MenuItem(user_id=1, name="Chantrelle Toast",
                     description="Crispy Toast with Sesame Seeds "
                                 "slathered with buttery chantrelle "
                                 "mushrooms",
